...
export default function App() {
    ...
    return (_jsxs("div", { style: { padding: 20 }, children: [_jsx("h2", { children: "Media SDK" }), _jsx("div", { style: {
                    display: "flex",
                    alignItems: "center",
                    gap: "10px",
                    padding: "12px 16px",
                    ...
                    border: "1px solid rgba(0,0,0,0.05)",
                    transition: "all 0.25s ease",
                }, children: _jsx("input", { type: "text", placeholder: "Search images & videos...", value: query, onChange: (e) => setQuery(e.target.value), style: {
                        flex: 1,
                        background: "transparent",
                        border: "none",
                        outline: "none",
                        ...
                        fontFamily: "inherit",
                        letterSpacing: "0.2px",
                    } }) }), loading && page === 1 && _jsx("p", { children: "Loading..." }), _jsx("h3", { children: "Images" }), _jsx(Grid, { items: images, renderItem: (photo) => (_jsx("img", { src: photo.src?.medium, loading: "lazy", onClick: () => {
                        const index = images.findIndex((p) => p.id === photo.id);
